...
<head>
  ...
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="../App/View/template/set/css/loader/loaders.css">
    ...
    <link rel="stylesheet" href="../App/View/template/set/css/bootstrap.css">
    <link rel="stylesheet" href="../App/View/template/set/css/aos/aos.css">
    <link rel="stylesheet" href="../App/View/template/set/css/swiper/swiper.css">
    <link rel="stylesheet" href="../App/View/template/set/css/lightgallery.min.css">
    <link rel="stylesheet" href="../App/View/template/set/photo/css/galerie.css">
    <!--slider-->
    <link rel="stylesheet" type="text/css" href="../App/View/template/set/slider/css/style.css">
    <link rel="stylesheet" type="text/css" href="../App/View/template/set/slider/css/lightslider.css">
    ...
    <script type="text/javascript" src="../App/View/template/set/slider/js/lightslider.js"></script>
...
<body class="g-sidenav-show   bg-gray-100" 6>
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="?src=roxanne">
        ...
        <li class="nav-item">
          <a class="nav-link " href="?src=9f3642c94c2f071704f2ac2ad3a0b1891634b9b9">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">A propos</span>
          </a>
        </li>
        <li class="nav-item">
  ...
  <div class="fixed-plugin">
    ...
    <!-- Footer Endt -->
        <!--slider-->
        <script type="text/javascript" src="../App/View/template/set/slider/js/script.js"></script>
        
    
    <!--jQuery-->
    
    <!--Plugins-->
    <script src="../App/View/template/set/js/bootstrap.bundle.js"></script>
    <script src="../App/View/template/set/js/loaders.css.js"></script>
    <script src="../App/View/template/set/js/aos.js"></script>
    <script src="../App/View/template/set/js/swiper.min.js"></script>
    <script src="../App/View/template/set/js/lightgallery-all.min.js"></script>
  ...
  <script src="../App/View/template/admin/assets/js/plugins/chartjs.min.js"></script>
    ...
    <script type="text/javascript" src="../App/View/template/set/slider/js/script.js"></script>
    <!--Template Script-->
    <script src="../App/View/template/set/js/main.js"></script>
