      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Connection!</h1>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form method="post" action="" enctype="multipart/form-data"  role="form">
                ...
                <p class="text-sm mt-3 mb-0">Vous n'avez pas un compte? <a href="?src=signUp" class="text-dark font-weight-bolder">S'insrire</a></p>
              </form>
            </div>
          </div>
        </div>
