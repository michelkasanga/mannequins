                 ...
                 <form method="post" action="" enctype="multipart/form-data">
                     ...
                     <div class="mb-3">
                        ...
                        <div class="input-group input-group-lg input-group-xs">
                          ...
                          <input type="text" class="form-control" placeholder="Entrez le nom complet de ton manager" name="name" value="<?= $find->name;?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="input-group input-group-lg input-group-xs">
                          ...
                          <input type="email" class="form-control" placeholder="l'adresse email de ton manager" name="email" value="<?= $find->email;?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="input-group input-group-lg input-group-xs">
                          ...
                          <input type="tel" class="form-control" placeholder="son numero ou son WhatsApp" name="number_phone" value="<?= $find->number_phone;?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="input-group input-group-lg input-group-xs">
                          ...
                          <input type="text" class="form-control" placeholder="nationalité de ton manager" name="nationality" value="<?= $find->nationality;?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="input-group input-group-lg input-group-xs">
                          ...
                          <input type="number" class="form-control" placeholder="l'année de naissance de ton manager" name="year_b" value="<?= $find->year_b;?>">
                        </div>
                    </div>
